...
public class CartsController {
	...
	public @ResponseBody ResponseEntity<Cart>  viewCart(@PathVariable Integer cartId) {
		Cart cart=null;
		try {
	...
	public @ResponseBody ResponseEntity<Cart> deleteCart(@PathVariable Integer cartId,@PathVariable String itemId) {
	...
	public @ResponseBody ResponseEntity<Cart> applyPromocodeOnCart(@PathVariable Integer cartId,@PathVariable String promoCode) throws Exception {
		Cart createdItem = cartServiceImpl.applyPromoCodeOnCart(cartId, promoCode);
		return ResponseEntity.status(HttpStatus.OK).body(createdItem);
	}
}
